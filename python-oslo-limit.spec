...
BuildRequires:  python3-keystoneauth1 >= 3.9
BuildRequires:  python3-openstacksdk >= 0.31.1
BuildRequires:  python3-oslo-config >= 5.2
BuildRequires:  python3-oslo-i18n >= 3.15.3
BuildRequires:  python3-oslo-log >= 3.44
BuildRequires:  python3-oslotest >= 3.2
BuildRequires:  python3-stestr

Requires:       python3-keystoneauth1 >= 3.9
Requires:       python3-openstacksdk >= 0.31.1
Requires:       python3-oslo-config >= 5.2
Requires:       python3-oslo-i18n >= 3.15.3
Requires:       python3-oslo-log >= 3.44
